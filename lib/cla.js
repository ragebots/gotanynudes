...
const printUsage = () => {
  const sections = [
    {
      header: 'GotAnyNudes video and photo gallery saver',
      content: 'Save video/images from a list of GotAnyNudes urls.'
    },
    {
      header: 'Options',
      optionList: [
        ...
        },
        {
          ...
          description: 'The input url from dirtyship to save video/gallery images from.'
        },
        {
          name: 'help',
          alias: 'h',
